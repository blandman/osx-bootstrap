...
if [[ ! -f ~/.osx-bootstrap/.osx-bootstrap ]]; then
    ...
    formulas=(
        ...
        'sudo defaults write NSGlobalDomain com.apple.finder EmptyTrashSecurely -bool true'
        'sudo defaults write NSGlobalDomain com.apple.finder FXEnableExtensionChangeWarning -bool false'
        ...
        'sudo defaults write NSGlobalDomain com.apple.finder _FXShowPosixPathInTitle -bool NO'
        'sudo defaults write NSGlobalDomain com.apple.finder QLEnableTextSelection -bool true'
        'sudo defaults write NSGlobalDomain com.apple.finder ShowPathbar -bool true'
        'sudo defaults write NSGlobalDomain com.apple.finder ShowStatusBar -bool true'
        'sudo defaults write NSGlobalDomain com.apple.desktopservices DSDontWriteNetworkStores -bool true'
        ...
        'sudo defaults write NSGlobalDomain com.apple.dock "expose-group-by-app" -bool true'
        'sudo defaults write NSGlobalDomain com.apple.dock itunes-notifications -bool true'
        'sudo defaults write NSGlobalDomain com.apple.dock show-process-indicators -bool true'
        'sudo defaults write NSGlobalDomain com.apple.dock showhidden -bool true'
        'find ~/Library/Application\ Support/Dock -name "*.db" -maxdepth 1 -delete'
        'sudo defaults write NSGlobalDomain com.apple.Safari DebugSnapshotsUpdatePolicy -int 2'
        'sudo defaults write NSGlobalDomain com.apple.Safari IncludeInternalDebugMenu -bool true'
        'sudo defaults write NSGlobalDomain com.apple.Safari ProxiesInBookmarksBar "()"'
        'sudo defaults write NSGlobalDomain com.apple.Safari IncludeDevelopMenu -bool true'
        'sudo defaults write NSGlobalDomain com.apple.Safari WebKitDeveloperExtrasEnabledPreferenceKey -bool true'
        'sudo defaults write NSGlobalDomain com.apple.Safari "com.apple.Safari.ContentPageGroupIdentifier.WebKit2DeveloperExtrasEnabled" -bool true'
        ...
        'sudo defaults write NSGlobalDomain com.apple.TimeMachine DoNotOfferNewDisksForBackup -bool true'
        ...
        'sudo defaults write NSGlobalDomain com.apple.LaunchServices LSQuarantine -bool false'
        ...
        'sudo defaults write NSGlobalDomain com.apple.dashboard mcx-disabled -bool true'
        'sudo defaults write NSGlobalDomain com.apple.dock dashboard-in-overlay -bool true'
        'sudo defaults write NSGlobalDomain com.apple.dock autohide-delay -float 0'
        'sudo defaults write NSGlobalDomain com.apple.dock autohide -bool false'
